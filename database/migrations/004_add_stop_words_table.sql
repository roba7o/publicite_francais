...
-- Used by analytics queries to filter out common words

-- =====================================================
-- Stop Words Reference Table - Simple Lookup
-- =====================================================

CREATE TABLE IF NOT EXISTS news_data_dev.stop_words (
    word TEXT PRIMARY KEY,
    language VARCHAR(10) DEFAULT 'fr',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);

CREATE TABLE IF NOT EXISTS news_data_test.stop_words (
    word TEXT PRIMARY KEY,
    language VARCHAR(10) DEFAULT 'fr',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);

CREATE TABLE IF NOT EXISTS news_data_prod.stop_words (
    word TEXT PRIMARY KEY,
    language VARCHAR(10) DEFAULT 'fr',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- =====================================================
-- Populate Stop Words from File Data
-- =====================================================

-- French stop words (from dbt/resources/french-stop-words.txt)
INSERT INTO news_data_dev.stop_words (word, language) VALUES
...
INSERT INTO news_data_test.stop_words (word, language) VALUES
('a', 'fr'), ('an', 'fr'), ('and', 'fr'), ('are', 'fr'), ('as', 'fr'), ('at', 'fr'),
('be', 'fr'), ('but', 'fr'), ('by', 'fr'), ('for', 'fr'), ('if', 'fr'), ('in', 'fr'),
('into', 'fr'), ('is', 'fr'), ('it', 'fr'), ('no', 'fr'), ('not', 'fr'), ('of', 'fr'),
('on', 'fr'), ('or', 'fr'), ('s', 'fr'), ('such', 'fr'), ('t', 'fr'), ('that', 'fr'),
...
INSERT INTO news_data_prod.stop_words (word, language) VALUES
('a', 'fr'), ('an', 'fr'), ('and', 'fr'), ('are', 'fr'), ('as', 'fr'), ('at', 'fr'),
('be', 'fr'), ('but', 'fr'), ('by', 'fr'), ('for', 'fr'), ('if', 'fr'), ('in', 'fr'),
('into', 'fr'), ('is', 'fr'), ('it', 'fr'), ('no', 'fr'), ('not', 'fr'), ('of', 'fr'),
('on', 'fr'), ('or', 'fr'), ('s', 'fr'), ('such', 'fr'), ('t', 'fr'), ('that', 'fr'),
...
CREATE INDEX IF NOT EXISTS idx_dev_stop_words_word ON news_data_dev.stop_words(word);
CREATE INDEX IF NOT EXISTS idx_test_stop_words_word ON news_data_test.stop_words(word);
CREATE INDEX IF NOT EXISTS idx_prod_stop_words_word ON news_data_prod.stop_words(word);